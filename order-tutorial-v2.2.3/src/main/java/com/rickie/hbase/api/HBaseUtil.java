...
public class HBaseUtil {
    ...
    public static boolean createTable(String tableName, String... familyNames) throws IOException {
        ...
        // 增加列族
        tableBuilder.setColumnFamilies(createColumnFamilyList(familyNames));
        // 构造预分区键值
     ...
     * @return 列族描述器
     */
    private static List<ColumnFamilyDescriptor> createColumnFamilyList(String...familyNames){
        List<ColumnFamilyDescriptor> results = new ArrayList<>();
        // 设置默认列族 info
        if(familyNames == null || familyNames.length == 0){
            familyNames = new String[]{"info"};
        }
        ...
        for (String family : familyNames) {
            ...
            descriptorBuilder.setTimeToLive(365*24*3600);
            descriptorBuilder.setMaxVersions(3);
    ...
    public static boolean deleteColumnFamily(String tableName, String cfName) {
        try(HBaseAdmin admin = (HBaseAdmin) HBaseConnectionFactory.getConnection().getAdmin()) {
